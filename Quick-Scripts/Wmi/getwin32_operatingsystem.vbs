...
Sub WMIObjwin32_operatingsystemDisplay( byval WmiItemCol)
	'-------------------------------------------------------------------------------
	' WMIObjwin32_operatingsystemDisplay - Used to gather WMI object from Win32_win32_operatingsystem
	' Parameters:
	'	StrComputerName 	- IP or name  
	'	ExportMode			- export to csv HTML or js mode. ( options are : CVS , HTML , JS , FULL)
	' Returns:
	'   Execution Computername as tring.
	'-------------------------------------------------------------------------------
	Call StackTraceBuilder("WMIObjwin32_operatingsystemDisplay","Add")
	...
	For Each objItem in WmiItemCol
				...
				Result = Result & ";" & objItem.bootdevice
				Result = Result & ";" & objItem.buildnumber
				Result = Result & ";" & objItem.buildtype
				Result = Result & ";" & objItem.caption
				Result = Result & ";" & objItem.codeset
				Result = Result & ";" & objItem.countrycode
				Result = Result & ";" & objItem.creationclassname
				Result = Result & ";" & objItem.cscreationclassname
				Result = Result & ";" & objItem.csdversion
				Result = Result & ";" & objItem.csname
				Result = Result & ";" & objItem.currenttimezone
				Result = Result & ";" & objItem.dataexecutionprevention_32bitapplications
				Result = Result & ";" & objItem.dataexecutionprevention_available
				Result = Result & ";" & objItem.dataexecutionprevention_drivers
				Result = Result & ";" & objItem.dataexecutionprevention_supportpolicy
				Result = Result & ";" & objItem.debug
				Result = Result & ";" & objItem.description
				Result = Result & ";" & objItem.distributed
				Result = Result & ";" & objItem.encryptionlevel
				Result = Result & ";" & objItem.foregroundapplicationboost
				Result = Result & ";" & objItem.freephysicalmemory
				Result = Result & ";" & objItem.freespaceinpagingfiles
				Result = Result & ";" & objItem.freevirtualmemory
				Result = Result & ";" & DateFormatParse(objItem.installdate)
				Result = Result & ";" & objItem.largesystemcache
				Result = Result & ";" & objItem.lastbootuptime
				Result = Result & ";" & objItem.localdatetime
				Result = Result & ";" & objItem.locale
				Result = Result & ";" & objItem.manufacturer
				Result = Result & ";" & objItem.maxnumberofprocesses
				Result = Result & ";" & objItem.maxprocessmemorysize
				If isNull(objItem.muilanguages) Then
						Result = Result & ";" & "Unknown"
					Else
						Result = Result &  ";"  & Join(objItem.muilanguages, ",")
				End If
				Result = Result & ";" & objItem.name
				Result = Result & ";" & objItem.numberoflicensedusers
				Result = Result & ";" & objItem.numberofprocesses
				Result = Result & ";" & objItem.numberofusers
				Result = Result & ";" & objItem.operatingsystemsku
				Result = Result & ";" & objItem.organization
				Result = Result & ";" & objItem.osarchitecture
				Result = Result & ";" & objItem.oslanguage
				Result = Result & ";" & objItem.osproductsuite
				Result = Result & ";" & objItem.ostype
				Result = Result & ";" & objItem.othertypedescription
				Result = Result & ";" & objItem.paeenabled
				Result = Result & ";" & objItem.plusproductid
				Result = Result & ";" & objItem.plusversionnumber
				Result = Result & ";" & objItem.primary
				Result = Result & ";" & objItem.producttype
				Result = Result & ";" & objItem.quantumlength
				Result = Result & ";" & objItem.quantumtype
				Result = Result & ";" & objItem.registereduser
				Result = Result & ";" & objItem.serialnumber
				Result = Result & ";" & objItem.servicepackmajorversion
				Result = Result & ";" & objItem.servicepackminorversion
				Result = Result & ";" & objItem.sizestoredinpagingfiles
				Result = Result & ";" & objItem.status
				Result = Result & ";" & objItem.suitemask
				Result = Result & ";" & objItem.systemdevice
				Result = Result & ";" & objItem.systemdirectory
				Result = Result & ";" & objItem.systemdrive
				Result = Result & ";" & objItem.totalswapspacesize
				Result = Result & ";" & objItem.totalvirtualmemorysize
				Result = Result & ";" & objItem.totalvisiblememorysize
				Result = Result & ";" & objItem.version
				Result = Result & ";" & objItem.windowsdirectory
				Call  WriteLine(Result)
				Result = ""
			Next
	Call StackTraceBuilder("win32_operatingsystem","REMOVE")
...
Sub Main
	...
	WMICSVReportFile =  "win32_operatingsystem"
	BaseComputerName = GetComputerName(BaseComputerName)
	Call BuildLogsDirs
	Call GetWMIObj(BaseComputerName, " SELECT * FROM win32_operatingsystem", "\root\cimv2")
	call WMIObjwin32_operatingsystemDisplay(colItems)
	Call MakeTable( StrFilePathToWriteHTMLCmp & "\" & WMICSVReportFile & "-" & StrFileDate & ".HTML", StrFilePathToWriteCSVCmp & "\" & WMICSVReportFile & "-" & StrFileDate & ".csv","win32_operatingsystem Repport","win32_operatingsystem Repport")
